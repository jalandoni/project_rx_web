            ...
            <ul class="first-ul">
              ...
              <li>
                ...
                <ul class="second-ul">
                  ...
                  <li>
                    We may collect certain information about your computer or other devices that you use to access the Program, including IP address, type, browser language, and location.
                  </li>
                  ...
                  <li>
                    A “cookie” is a small text file stored on your computer or other devices when you visit certain web pages that record your preferences and actions. Most web browsers automatically accept cookies, but, if you prefer, you can usually modify your browser setting to decline cookies. However, please note that refusing a cookie may limit your access to or use of the Sites.
                  </li>
              </ul>
              </li>
              ...
              <li>
                {{common.COMPANY}} will share aggregate or anonymous data collected through the Service, including Activity Data, for purposes such as understanding or improving the service.
                  <ul>
                    ...
                    <li>
                      You can manage your account settings by clicking <span class="link" data-toggle="modal" data-target="#privacyModal" @click="direct()">here</span> to update, amend, and correct your information.
                    </li>
                    <li>
